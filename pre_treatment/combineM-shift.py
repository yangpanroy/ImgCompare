...
m_shift_img = cv2.imread("/media/files/yp/rbm/pic_div/combine_MS/2016gf2457.TIF")
prediction_img = cv2.imread("/media/files/yp/rbm/pic_div/combine_MS/2016gf2457.jpg")
# cv2.imshow("M-shift Img", m_shift_img)
# cv2.imshow("prediction Img", prediction_img)
# cv2.waitKey(0)
...
areaList = convert2Areas(m_shift_img, 10)  # 先将meanshift图像转为对象列表
